    ...
    <QuizCard>
      <div className="text-center">
        ...
        <p className="text-sm text-muted-foreground mb-8 font-body">
          ...
          <a 
            href="https://santa-s-winter-web-quest.lovable.app"
            target="_blank"
            rel="noopener noreferrer"
            className="text-ice hover:text-gold transition-colors underline underline-offset-4"
          >
        ...
        <Button
          onClick={onStart}
          size="lg"
          className="font-body text-lg px-8 py-6 glow-gold"
        >
          Begin Your Quest
        </Button>
      </div>
